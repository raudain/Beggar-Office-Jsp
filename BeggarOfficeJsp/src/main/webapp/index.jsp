...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div style="margin-top: 35px">
      <img src="images/change-inc.jpg" style="display: block; margin-left: auto; margin-right: auto; width: 750px;">
      <div style="margin-left: auto; margin-right: auto; width: 1000px; background-color: #729DBD;">
        <div class="row row35">
          <div class="room">
    ...
    <script>
      var columnHeight = 144;
      var marginTop = 72;
      var rowHeight = columnHeight + marginTop;
      var numberOfRows = 34 + 1;
      var buildingHeight = rowHeight * numberOfRows;
      document.getElementById("building").style.height = buildingHeight + "px";
    </script>
  </body>
</html>
